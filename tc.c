...
// #define PORTA_SERVIDOR_TCP 8888
...
int main(int argc, char *argv[])
{
    ...
    char mensagem[TAM_MAX_MENSAGEM]; /* Buffer para a recep��o da string de echo */
    char IP[255];       /* Endere�o IP do servidor */
#ifdef WIN
    WORD wPackedValues;
    WSADATA  SocketInfo;
    int      nLastError,
    ...
    resultado = conectar_com_outro_dispositivo(sock,IP,PORTA_SERVIDOR);
    if (resultado < 0)
    {
